    	...
    	<div class="panel panel-info">
    		...
    		<div class="panel-body p-n stepy-info">
    			...
    			<%
        			...
        			%>
    				<input type="hidden" name="actionCode" value="allocated">
    				
        			<input id="profileid" class="form-control" value="<%=issue.getProfileid()%>" type="hidden" name="profileid" >
                    
                    			<input id="f_name" class="form-control" value="<%=issue.getTitle()%>" name="title"  type="hidden"  required placeholder="Enter the Roll Id" >
    					
    						<input id="f_name" class="form-control" value="<%=issue.getIsuuetype()%>" name="i_type"  type="hidden"  required placeholder="Enter the Roll Id" >
    					
    							<input id="f_name" class="form-control" value="<%=issue.getEmployee_email()%>" name="email"  type="hidden"  required placeholder="Enter the Roll Id" >
    						
    					
    							<input id="f_name" class="form-control" value="<%=issue.getDiscribeisuue()%>" name="discribe"  type="hidden"  required placeholder="Enter the Roll Id" >
    					<%} %>
    					
    					<div class="form-group">
				<label class="col-md-3 control-label">Engineer Name</label>
				<div class="col-md-6">
				
  								
					<select class="form-control" id="r_type" name="e_email" required  >
					
						<optgroup >
							<option></option>
							<%
							Iterator <profile> iterator2=arrayList2.iterator();
							...
							<option value=<%=profile.getEmail() %>><%=profile.getFirstname()%>  <%=profile.getLastname()	 %></option>
							...
							<%} %> 
    							...
    							<input  class="form-control" value="Pannding" name="status"  type="hidden"  required  >
