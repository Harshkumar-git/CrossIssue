...
%>
    ...
    <%
    ArrayList<profile> arrayList=(ArrayList)session.getAttribute("updateuser1");/*dao methode name in ""  */
    ...
    <div class="col-md-12">
    	<div class="panel panel-info">
    		...
    		<div class="panel-body p-n stepy-info">
        			...
        			%>
        			<input type="hidden" name="actionCode" value="update">
        			<input id="profileid" class="form-control" value="<%=profile.getProfileid()%>" type="hidden" name="profileid" >
        			 ...
        			 <div class="form-group">
    						...
    						<div class="col-md-6">
    							<input id="r_type" class="form-control" value="<%= profile.getRolltype()%>" name="r_type" type="text">
    						</div>
    					</div>
                       ...
                       <div class="form-group">
    						...
    						<div class="col-md-6">
    							<input id="f_name" class="form-control" value="<%=profile.getFirstname() %>" name="f_name" minlength="4" type="text" required >
    						</div>
    					</div>
    					<div class="form-group">
    						<label for="fieldname" class="col-md-3 control-label">Last Name</label>
    						<div class="col-md-6">
    							<input id="f_name" class="form-control" value="<%=profile.getLastname()%>" name="l_name" minlength="4" type="text" required >
    						</div>
    					</div>
    					<div class="form-group">
    						...
    						<input type="text" value="<%=profile.getDob() %>" class="form-control" minlength="4" required name="dob">
    					   </div> 
    					</div>
    					</div>
    					...
    					<div class="form-group">
    						<label for="fieldname" class="col-md-3 control-label">Gender</label>
    						<div class="col-md-6">
    							<input id="f_name" class="form-control" value="<%=profile.getGender() %>" name="gender" minlength="4" type="text" required >
    						</div>
    					</div>
    					...
    					<div class="form-group">
    						...
    						<div class="col-md-6">
    							<input id="city" class="form-control" value="<%=profile.getCity() %>" name="city"  type="text" required >
    						</div>
    					</div>
                       	...
                       	<div class="form-group">
    						...
    						<div class="col-md-6">
    							<input id="city" class="form-control" value="<%=profile.getState() %>" name="state"  type="text" required >
    						</div>
    					</div>
    					...
    					<div class="form-group" >
    						...
    						<div class="col-md-6">
    						<input id="address" class="form-control" value="<%=profile.getAddress()%>" name="add" type="text" required>
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control mask" value="<%=profile.getMobileNo() %>" data-inputmask="'mask':'+91 999 999 999'" name="mobile">
                        </div>
                        <div class="col-sm-3"><p class="help-block">+33 999 999 999</p></div>
                    </div>
                    <div class="form-group">
    						<label for="fieldemail" class="col-md-3 control-label">Email</label>
    						<div class="col-md-6"><input id="fieldemail" value="<%=profile.getEmail() %>" class="form-control" type="email" name="email" required></div>
    					</div>
    					
    					<div class="form-group">
    						<label class="col-md-3 control-label">Password</label>
    						<div class="col-md-6">
    							<input type="text" class="form-control" value="<%=profile.getPassword() %>" name="password" required minlength="8">
    						</div>
						...
						<div class="col-sm-5">
							<div class="fileinput fileinput-new" style="width: 100%;" data-provides="fileinput"><input type="hidden" value="" name="...">
								<div class="fileinput-preview thumbnail mb20" data-trigger="fileinput" style="width: 100%; height: 150px; line-height: 150px;"><img src="<%=request.getContextPath() %>/img/<%=profile.getProfilepic()%>" ></div>
