...
%>
    ...
    <%
    ArrayList<Issuetype> arrayList=(ArrayList)session.getAttribute("issuetype");/*dao methode name in ""  */
    %>
    ...
    <body class="infobar-offcanvas">
        ...
        <div id="wrapper">
            <div id="layout-static">
    			...
    			<input type="hidden" name="actionCode" value="postissue">
                    
                    	<div class="form-group">
    						<label for="fieldname" class="col-md-3 control-label">Title</label>
    						<div class="col-md-6">
    							<input  class="form-control" name="title"  type="text" required placeholder="Enter the Title" required>
    						</div>
    					</div>
    					
    					<div class="form-group">
    						<label for="fieldname" class="col-md-3 control-label">Employe E-mail</label>
    						<div class="col-md-6">
    							<input  class="form-control" name="e_email"  type="text" required placeholder="Enter the Employe Id" required>
    						</div>
    					</div>
    					<div class="form-group">
				<label class="col-md-3 control-label">Issue Type</label>
				<div class="col-md-6">
										<select class="form-control" id="r_type" name="i_type" required>
											<optgroup required>
												<option></option>
												<%
                       		Iterator iterator=arrayList.iterator();
									...
									Issuetype issuetype=(Issuetype)iterator.next();
										...
										%>
												<option required><%=issuetype.getIssueType() %></option>
    					...
    					<div class="form-group">
    						...
    						<div class="col-md-6">
    							<textarea required cols="2" rows="5" name="discribe_issue" class="form-control" placeholder="Discribe of Isuue"></textarea>
    						</div>
    					</div>
