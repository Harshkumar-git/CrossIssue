...
<link type="text/css" href="../../assets/plugins/switchery/switchery.css" rel="stylesheet">                        <!-- Switchery -->
    ...
    <div class="col-md-12">
    	...
    	<div class="panel panel-info">
                    ...
                    <div class="col-md-4">
		<a href="#" class="tectonic-info-tile pink">
			<div class="tile-heading">
				<span class="title">Employee</span>
			</div>
			<div class="tile-body">
				<span class="text"><sup>$</sup>6,750</span>
	...
	<div class="col-md-4">
		<a href="#" class="tectonic-info-tile info">
			<div class="tile-heading">
				<span class="title">Engineer</span>
			</div>
			<div class="tile-body">
				<span class="text"><sup>$</sup>5,953</span>
				<span class="sparkline bar" id="tectonicinfotile2p"><canvas width="40" height="40" style="display: inline-block; width: 40px; height: 40px; vertical-align: top;"></canvas></span>
			<div class="tile-footer">
			</div>
	...
	<div class="col-md-4">
		<a href="#" class="tectonic-info-tile purple">
			<div class="tile-heading">
				<span class="title">Issue</span>
			</div>
			<div class="tile-body">
				<span class="text"><sup>$</sup>861</span>
				<span class="sparkline bar" id="tectonicinfotile4p"><canvas width="40" height="40" style="display: inline-block; width: 40px; height: 40px; vertical-align: top;"></canvas></span>
			</div>
			<div class="tile-footer">
