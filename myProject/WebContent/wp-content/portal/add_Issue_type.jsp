...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
    ArrayList<department> arrayList=(ArrayList)session.getAttribute("viewdept");/*dao methode name in ""  */
    %>
     <%
    ...
    <div class="col-md-12">
    	...
    	<div class="panel panel-info">
    		...
    		<div class="panel-body p-n stepy-info">
    			...
    			<input type="hidden" name="actionCode" value="issuetype">
                    
    					
    					<div class="form-group">
    						<label for="fieldname" class="col-md-3 control-label">Issue Type</label>
    						<div class="col-md-6">
    							<input id="f_name" class="form-control" name="i_type"  type="text" required placeholder="Enter the Roll Id">
    						</div>
    					</div>
    					
    					<div class="form-group">
				<label class="col-md-3 control-label">Issue Department</label>
				<div class="col-md-6">
							...
							<%
                       		Iterator iterator=arrayList.iterator();
									...
									department department=(department)iterator.next();
										...
										%>
								<option><%=department.getDeaprtment_Name() %></option>
