...
<%@page import="com.model.postissue" %>
...
%>
    ...
    <%
    ArrayList<postissue> arrayList=(ArrayList)session.getAttribute("viewissue");/*dao methode name in  "" */
    ArrayList<profile>arrayList2=(ArrayList)session.getAttribute("employee");
    %>
...
<link type="text/css" href="../../assets/plugins/switchery/switchery.css" rel="stylesheet">                        <!-- Switchery -->
    ...
    <body class="infobar-offcanvas">
        ...
        <div id="wrapper">
            <div id="layou"WebContent/wp-content/portal/allocationupdate.jsp"t-static">
			...
			<div class="panel-body p-n">
				...
				<table id="example" class="table table-striped table-bordered dataTable no-footer" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
					<thead>
						...
						<th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column ascending" style="width: 234.2px;">Employee</th>
						<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 268.2px;">Issue Type</th>
						<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 319.2px;">Issue Detail</th>
						<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 319.2px;">Employee</th>
						<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 198.2px;"></th>
					...
					<%
                       		Iterator<postissue> iterator=arrayList.iterator();	
							
				
										while(iterator.hasNext())
										{
											
									postissue issue=(postissue)iterator.next();
                       		...
                       		<tr>
                       		<td><%=issue.getTitle() %>
                       		<td><%=issue.getEmployee_email() %></td>
                       		<td><%=issue.getIsuuetype() %></td>
                       		<td><%=issue.getDiscribeisuue() %></td>
                       		
                       		
                        <td><a href="<%=request.getContextPath() %>/Controller?actionCode=allocate&view_id=<%=issue.getProfileid()%>" class="btn btn-success btn-label"><i class="ion-android"></i>Allocate </a></td> 
                       		<%  }%>
