    	...
    	<div class="panel panel-info">
    		...
    		<div class="panel-body p-n stepy-info">
    			...
    			<%
        			...
        			<input id="profileid" class="form-control" value="<%=issue.getProfileid()%>" type="hidden" name="profileid" >
    						...
    						<input id="f_name" class="form-control" value="<%=issue.getIsuuetype()%>" name="i_type"  type="hidden"  required placeholder="Enter the Roll Id" >
    							...
    							<input id="f_name" class="form-control" value="<%=issue.getEmployee_email()%>" name="e_email"  type="hidden"  required placeholder="Enter the Roll Id" >
				...
				<div class="col-md-6">
					...
					<select class="form-control" id="r_type" name="e_name" required  >
						...
						<optgroup >
							...
							<option><%=profile.getFirstname()%>  <%=profile.getLastname()	 %></option>
							<%} %> 
