    ...
    <div class="col-md-12">
    	...
    	<div class="panel panel-info">
    		...
    		<div class="panel-body p-n stepy-info">
    			...
    			<input type="hidden" name="actionCode" value="adddept">
                    <div class="form-group">
    						<label for="fieldname" class="col-md-3 control-label">Department Name</label>
    						<div class="col-md-6">
    							<input id="f_name" class="form-control" name="d_name" type="text" required placeholder="Enter the Department Name">
    						</div>
    					</div>
    					
    					<div class="form-group">
    						<label for="fieldname" class="col-md-3 control-label">Department Id</label>
    						<div class="col-md-6">
    							<input id="f_name" class="form-control" name="d_id"  type="text" required placeholder="Enter the Department Id">
    						</div>
    					</div>
