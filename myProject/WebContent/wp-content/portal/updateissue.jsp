    	...
    	<div class="panel panel-info">
    		...
    		<div class="panel-body p-n stepy-info">
    			...
    			<%
        			...
        			%>
    				<input type="hidden" name="actionCode" value="updateissue1">
        			<input id="profileid" class="form-control" value="<%=issue.getProfileid()%>" type="hidden" name="profileid" >
                    		
                    	<div class="form-group">
    						<label for="fieldname" class="col-md-3 control-label">Title</label>
    						<div class="col-md-6">
    							<input id="f_name" class="form-control" value="<%=issue.getTitle()%>" name="title"  type="text" required placeholder="Enter the Roll Id" >
    						</div>
    					</div>
    					
    					<div class="form-group">
    						<label for="fieldname" class="col-md-3 control-label">Employee id</label>
    						<div class="col-md-6">
    							<input id="f_name" class="form-control" value="<%=issue.getEmployee_email()%>" name="e_id"  type="text" required placeholder="Enter the Roll Id" >
    						</div>
    					</div>
    					...
    					<div class="form-group">
    						...
    						<div class="col-md-6">
    							<input id="f_name" class="form-control" value="<%=issue.getIsuuetype() %>" name="i_type"  type="text" required placeholder="Enter the Roll Id">
    						</div>
    					</div>
    					<div class="form-group">
    						<label for="fieldname" class="col-md-3 control-label">Describe the issue</label>
    						<div class="col-md-6">
    							<textarea cols="2" rows="5" name="discribe_issue"  class="form-control"  ><%=issue.getDiscribeisuue() %></textarea>
    						</div>
    					</div>
    						<%} %>
