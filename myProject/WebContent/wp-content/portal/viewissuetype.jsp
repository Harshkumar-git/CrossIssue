...
%>
    ...
    <%
    ArrayList<Issuetype> arrayList=(ArrayList)session.getAttribute("viewissuetype");/*dao methode name in ""  */
    %>
			...
			<div class="panel-body p-n">
				<div id="example_wrapper" class="dataTables_wrapper form-inline no-footer"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><table id="example" class="table table-striped table-bordered dataTable no-footer" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
					<thead>
						...
						<thead>
                       		<tr>
                       		<th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column ascending" >Issue Type</th>
                       		<th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column ascending" >Issue Department</th>
					...
					<%
                       		...
                       		<td><%=issue.getIssueDepartment() %></td>
                       		
                       		<td><a href="<%=request.getContextPath() %>/Controller?actionCode=updateissuetype&view_id=<%=issue.getProfileid() %>" class="btn btn-success btn-label"><i class="ion-android"></i>Update</a></td>
                       		<%} %>
                       		</tr>
